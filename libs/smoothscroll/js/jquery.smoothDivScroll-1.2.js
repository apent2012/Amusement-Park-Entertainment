	...
	//		var hack = -(el.data("scrollerOffset").left - 40);		// 3370
        ...
        $('.team-body-people-slider-person-redsq').css('cursor', 'default');
			...
			*****************************************/
			...
			//	console.log(el.data("scrollerOffset").left);
				var parentOffset = $(this).parent().offset(); 
				var x = Math.abs(e.pageX - parentOffset.left - 327) + 80;
			//	console.log(x);

			//	var x = ((this.offsetLeft + el.data("scrollerOffset").left + hack + el.data("hotSpotWidth")) - e.pageX);
			//	console.log(x);
				el.data("scrollXPos", Math.round((x / el.data("hotSpotWidth")) * o.hotSpotScrollingStep));
